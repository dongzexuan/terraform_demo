...
#
gcloud container clusters get-credentials maplarge --zone us-central1-a --project aaet-geoscience-prod
kubectl delete statefulset maplarge-master-ss
kubectl create -f /workspaces/lithos-infrastructure/MapLargeCluster/maplarge-master-ss_prod.yaml